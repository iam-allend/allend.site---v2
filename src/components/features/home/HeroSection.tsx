        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="inline-block">
              <span className="glass-strong px-4 py-2 rounded-full text-sm font-medium text-primary">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
              Digital
              <span className="block neon-text">Craftsman</span>
              <span className="block text-gray-500">& Designer</span>
            </h1>

            <p className="text-xl text-gray-400 max-w-lg">
              I build exceptional digital experiences through code and design. 
              <span className="text-primary"> Web development</span> meets 
            ...
            <div className="flex gap-4 pt-4">
                <a href="#" className="glass p-3 rounded-lg hover:glass-strong hover:scale-110 transition-all">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Next.js', 'React', 'TypeScript', 'Tailwind', 'Laravel', 'Flutter', 'Figma', 'Supabase'].map((tech) => (
                      <span key={tech} className="glass px-3 py-1 rounded-full text-xs">
                        {tech}
                      </span>
                    ))}
                  </div>
